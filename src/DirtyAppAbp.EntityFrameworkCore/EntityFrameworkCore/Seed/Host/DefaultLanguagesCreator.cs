...
namespace DirtyAppAbp.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = DirtyAppAbpConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(DirtyAppAbpDbContext context)
        {
            _context = context;
        }

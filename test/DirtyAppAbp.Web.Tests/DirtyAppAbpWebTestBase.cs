...
{
    public abstract class DirtyAppAbpWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DirtyAppAbpWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DirtyAppAbpWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DirtyAppAbpDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DirtyAppAbpDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DirtyAppAbpDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DirtyAppAbpDbContext, Task<T>> func)
        {
            T result;
